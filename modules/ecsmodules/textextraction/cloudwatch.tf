...
resource "aws_cloudwatch_metric_alarm" "cpu_high" {
  alarm_name          = "te-cpu-high-${var.environment}"
...
resource "aws_cloudwatch_metric_alarm" "cpu_low" {
  alarm_name          = "te-cpu-low-${var.environment}"
...
resource "aws_cloudwatch_metric_alarm" "memory_high" {
  alarm_name          = "te-memory-high-${var.environment}"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = var.evaluation_period_max
...
resource "aws_cloudwatch_metric_alarm" "memory_low" {
  alarm_name          = "te-memory-low-${var.environment}"
  comparison_operator = "LessThanOrEqualToThreshold"
  evaluation_periods  = var.evaluation_period_min
  metric_name         = "MemoryUtilization"
  namespace           = "AWS/ECS"
