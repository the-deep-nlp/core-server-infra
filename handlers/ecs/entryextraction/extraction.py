...
from const import HIGH_LEVEL_TAG_GROUPS, OPTIMIZED_PARAMETERS
...
def get_outputs_from_endpoint_text(document: str, endpoint_name: str):
    ...
    try:
        ...
        print("Error occurred while invoking the sagemaker endpoint. %s", str(cexc))
        raise cexc
...
def create_final_output(output: dict, 
